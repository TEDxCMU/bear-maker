...
export default function About() {
    ...
    <SaasProvider>
        <div className="aboutContainer">
            ...
            <a className="link" href="https://github.com/TEDxCMU">Github</a>
            </div>
